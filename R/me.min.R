...
#'
#' @return me.min the minimum size of m_e
#' @export
#' @importFrom stats qnorm
#'
#' @examples me.min(theta = 0.5, alpha = 0.05, beta = 0.1)
me.min <- function(theta, alpha, beta){
  me.min = ( 2/theta/theta ) * (qnorm(1-alpha) + qnorm(1-beta)*(1-theta))^2
  return(me.min)
}
